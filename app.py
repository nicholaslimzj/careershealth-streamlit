...
def main():
    ...
    if authentication_status == False:
        ...
        # Initialize session state for first login to trigger data fetch
        ...
        # If just authenticated, trigger data fetch
        if st.session_state.get("auth_initialized") and st.session_state.has_fetched:
            st.session_state.has_fetched = False
